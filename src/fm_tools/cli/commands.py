...
BUILTINS: tuple[Builtin, ...] = (
    ...
    Builtin("data-refine", "freeze, assess, review, and derive robot data", forwarding=True),
)
...
FORWARDING_USAGE: dict[str, str] = {
    ...
    "data-refine": "data-refine profiles|contract|assess|preview|review|derive [args...]",
}
